	...
	<div class="container">
		...
		<?php
			...
			!empty($zerif_copyright) || !empty($zerif_socials_instagram) ):
						...
						echo '<div class="zerif-copyright-box"><a class="zerif-copyright" href="" rel="nofollow">@ 2016 </a>'.__('','zerif-lite').'<a class="zerif-copyright" href="" rel="nofollow"> Cooperativa de Ahorro y Crédito "El Comerciante" Ltda.</a></div>';
